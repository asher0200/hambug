                    ...
                    <div class="flex">
                        ...
                        <div class="shrink-0 flex items-center" style="margin-top: 40px;">
                            <a href="Dashboard.html">
                                <img src='assets/' class='logo-img' alt='logo' />
                            </a>
                        </div>

                        <!-- Navigation Links -->
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex mt-3">
                            <a class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-300 hover:text-gray-100 hover:border-gray-100 focus:outline-none focus:text-gray-100 focus:border-gray-100 transition duration-150 ease-in-out" href="Dashboard.html">
                                Dashboard
                            </a>
                        </div>
                    </div>
