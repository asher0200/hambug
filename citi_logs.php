                            ...
                            <tbody>
                                ...
                                <tr class="border-b bg-gray-900 border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        Citi Bank </td>
                                    <td class="px-6 py-4">
                                        mtbank.com [login: password] + name + address + [email access] </td>
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="controllers/users_controllers/buy_citi-logic.php?id=mac2ZbDLGn96Ro0q" onclick="confirm_purchase(event)" class="inline-flex items-center px-2 py-2 bg-[#147c4f] border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-[#18945e] focus:bg-[#18945e] active:bg-[#18945e] focus:outline-none focus:ring-[#18945e] focus:ring-offset-2 transition ease-in-out duration-150">
                                ...
                                <tr class="border-b bg-gray-900 border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        Citi Bank </td>
                                    <td class="px-6 py-4">
                                        citibank.com [login: password] + name + address + [email access] </td>
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="controllers/users_controllers/buy_citi-logic.php?id=yZ6gSleePMfPYDK6" onclick="confirm_purchase(event)" class="inline-flex items-center px-2 py-2 bg-[#147c4f] border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-[#18945e] focus:bg-[#18945e] active:bg-[#18945e] focus:outline-none focus:ring-[#18945e] focus:ring-offset-2 transition ease-in-out duration-150">
                                            <script src="https://cdn.lordicon.com/bhenfmcm.js"></script>
                                            <lord-icon src="https://cdn.lordicon.com/cllunfud.json" trigger="loop" delay="1500" colors="outline:#ffffff,primary:#ffffff,secondary:#ffffff" stroke="60" style="width:30px;height:30px">
                                            </lord-icon>
                                            Buy
