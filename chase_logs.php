                    ...
                    <div class="flex">
                        ...
                        <div class="shrink-0 flex items-center" style="margin-top: 40px;">
                            <a href="Dashboard.html">
                                <img src='assets/dollas.jpeg' class='logo-img' alt='logo' />
                            </a>
                        </div>
                            ...
                            <tbody>
                                ...
                                <tr class="border-b bg-gray-900 border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        Chase Bank </td>
                                    <td class="px-6 py-4">
                                        chasebank.com [login: password] + name + [email: access] </td>
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="controllers/users_controllers/buy_chase-logic.php?id=P0x2TCwe68PFGCi9" onclick="confirm_purchase(event)" class="inline-flex items-center px-2 py-2 bg-[#147c4f] border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-[#18945e] focus:bg-[#18945e] active:bg-[#18945e] focus:outline-none focus:ring-[#18945e] focus:ring-offset-2 transition ease-in-out duration-150">
                                ...
                                <tr class="border-b bg-gray-900 border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="controllers/users_controllers/buy_chase-logic.php?id=lVYKN07Cih3Loee4" onclick="confirm_purchase(event)" class="inline-flex items-center px-2 py-2 bg-[#147c4f] border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-[#18945e] focus:bg-[#18945e] active:bg-[#18945e] focus:outline-none focus:ring-[#18945e] focus:ring-offset-2 transition ease-in-out duration-150">
                                            <script src="https://cdn.lordicon.com/bhenfmcm.js"></script>
                                            <lord-icon src="https://cdn.lordicon.com/cllunfud.json" trigger="loop" delay="1500" colors="outline:#ffffff,primary:#ffffff,secondary:#ffffff" stroke="60" style="width:30px;height:30px">
                                            </lord-icon>
                                            Buy
                                ...
                                <tr class="border-b bg-gray-900 border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="controllers/users_controllers/buy_chase-logic.php?id=dhc4yrf6S9hTBm73" onclick="confirm_purchase(event)" class="inline-flex items-center px-2 py-2 bg-[#147c4f] border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-[#18945e] focus:bg-[#18945e] active:bg-[#18945e] focus:outline-none focus:ring-[#18945e] focus:ring-offset-2 transition ease-in-out duration-150">
                                            <script src="cdn.lordicon.com/bhenfmcm.js"></script>
                                            <lord-icon src="cdn.lordicon.com/cllunfud.json" trigger="loop" delay="1500" colors="outline:#ffffff,primary:#ffffff,secondary:#ffffff" stroke="60" style="width:30px;height:30px">
                                            </lord-icon>
                                            Buy
                                        </a>
                                    </td>
                                ...
                                <tr class="border-b bg-gray-900 border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="controllers/users_controllers/buy_chase-logic.php?id=nyuj8ROKNlKS3wSt" onclick="confirm_purchase(event)" class="inline-flex items-center px-2 py-2 bg-[#147c4f] border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-[#18945e] focus:bg-[#18945e] active:bg-[#18945e] focus:outline-none focus:ring-[#18945e] focus:ring-offset-2 transition ease-in-out duration-150">
                                            <script src="bhenfmcm.js"></script>
                                            <lord-icon src="cllunfud.json" trigger="loop" delay="1500" colors="outline:#ffffff,primary:#ffffff,secondary:#ffffff" stroke="60" style="width:30px;height:30px">
                                            </lord-icon>
                                            Buy
                                        </a>
                                    </td>
